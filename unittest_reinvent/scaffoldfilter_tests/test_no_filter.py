...
class Test_no_scaffold_filter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        smiles = ["O=S(=O)(c3ccc(n1nc(cc1c2ccc(cc2)C)C(F)(F)F)cc3)N", "CCC", "CCCCC", "CC"]
        ...
        sf_parameters = ScaffoldParameters(name=self.scaffold_enum.NO_FILTER, minscore=0.5, minsimilarity=0.4, nbmax=1)

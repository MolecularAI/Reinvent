from running_modes.constructors.automated_curriculum_learning_mode_constructor import \
    AutomatedCurriculumLearningModeConstructor
from running_modes.constructors.lib_invent_reinforcement_learning_constructor import \
    LibInventReinforcementLearningModeConstructor
...
class RunningMode:
    def __new__(cls, configuration: GeneralConfigurationEnvelope) -> BaseRunningMode:
        ...
        if configuration.run_type == running_mode_enum.LIB_INVENT_REINFORCEMENT_LEARNING:
            return LibInventReinforcementLearningModeConstructor(configuration)

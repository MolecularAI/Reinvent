...
from running_modes.configurations import GeneralConfigurationEnvelope, AutomatedCurriculumLearningComponents
...
class AutomatedCurriculumLearningModeConstructor:
    def __new__(self, configuration: GeneralConfigurationEnvelope) -> BaseRunningMode:
        ...
        config = from_dict(data_class=AutomatedCurriculumLearningComponents, data=self._configuration.parameters)

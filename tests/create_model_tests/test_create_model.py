...
from reinvent.running_modes.configurations.logging.create_model_log_configuration import CreateModelLoggerConfiguration
from reinvent.running_modes.configurations.general_configuration_envelope import GeneralConfigurationEnvelope
from reinvent.running_modes.configurations.create_model.create_model_configuration import CreateModelConfiguration
from reinvent.running_modes.create_model.create_model import CreateModelRunner
from tests.fixtures.paths import MAIN_TEST_PATH, SMILES_SET_PATH
...
class Test_create_model(unittest.TestCase):
    ...
    def test_save_model_2(self):
        ...
        self.assertEqual(len(model.vocabulary.tokens()), 15)
